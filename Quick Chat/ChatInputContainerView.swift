...
class ChatInputContainerView: UIView, UITextFieldDelegate {
    ...
    var chatViewController: ChatViewController? {
        didSet {
            ...
            uploadImageView.addGestureRecognizer(UITapGestureRecognizer(target: chatViewController, action: #selector(ChatViewController.handleUploadTap)))
        }
    }
